  ...
  return (
    <section className="w-full h-[720px] p-2 md:p-4 lg:p-5 overflow-hidden">
      <div className="bg-[url('../public/hero.png'),linear-gradient(rgb(222,222,222),rgb(211,211,211))] bg-contain bg-no-repeat bg-right h-full flex items-center relative">
        ...
        <div className="pl-10 w-max z-10 md:mx-0 mx-auto cursor-default text-black bg-white/30 py-10 lg:bg-transparent">
          ...
          <div className="select-none text-[120px] sm:text-[220px] font-black leading-tight text-white/20 absolute -bottom-2 sm:-bottom-10 left-20 bg-blend-soft-light">
